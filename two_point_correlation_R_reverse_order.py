...
ff = numpy.loadtxt("input_output_files/theta_"+str(theta)+"/linear_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/f_gamma=0.4_max_err_1e-10_theta=1.0001_18000points_correction4_iter39.0_with_alpha.txt",float)
...
numpy.savetxt("input_output_files/theta_"+str(theta)+"/linear_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/two_point_correlation_function_R_new_theta="+str(theta)+"_gamma="+str(gamma)+"_18000points.txt", R, delimiter = ' ')
